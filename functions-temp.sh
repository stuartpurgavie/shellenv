...
function hv() {
    ...
    declare -A envs=(
        ...
        [tmo-prd]="https://vault.prod-services.t-mobile.com"
        #[tmo-prd]=""
    )
    ...
    case $1 in
        ...
        log)
            ...
            if [[ ${ttl} -lt $((60 * 60 * 24)) ]]; then echo "WARNING: Token TTL less than a day. Recommend hvtr &"; fi
